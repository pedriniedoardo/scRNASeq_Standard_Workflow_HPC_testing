...
rds <- "../../../results/Seurat/object/connect_5k_pbmc_NGSC3_ch1_gex_2_cellbender_obj_preQC.rds"
# rds <- snakemake@input$rds

# sample id
id_sample <- "connect_5k_pbmc_NGSC3_ch1_gex_2"
# id_sample <- snakemake@wildcards$sample_name

# read in the LUT_QC
# LUT_QC <- snakemake@input$LUT_QC
LUT_QC <- "../../../results/Seurat/table/LUT_QC_cellbender.csv"
...
out_id_meta <- "out/table/01_connect_5k_pbmc_NGSC3_ch1_gex_1_meta_preQC.rds"
